...
    })
  ...
  let submithandler = (data) => {
    axiosInstance
       ...
       .then((res) => {
        ...
        //  navigate("/admindashboard/",{id: a_id});
        //  console.log("/admindashboard/"+a_id);
  ...
  return (
    ...
    <div className="text-start ">
      <h2 className="text-center font-bold text-4xl from-blue-500 via-pink-500 to-red-500 bg-gradient-to-r bg-clip-text text-transparent">Add New Product</h2>
      <form
